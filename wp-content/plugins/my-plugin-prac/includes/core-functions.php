...
function myplugin_custom_logo_title($title) {
	$options = get_option('myplugin_options', myplugin_options_default());
...
add_filter( 'login_headertitle', 'myplugin_custom_logo_title' );
...
add_filter( 'login_enqueue_scripts', 'myplugin_custom_login_styles' );
